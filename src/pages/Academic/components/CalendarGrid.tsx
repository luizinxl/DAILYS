  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div className="grid grid-cols-7 gap-3 flex-1">
        {days.map((date, i) => {
          if (!date) {
            return <div key={`empty-${i}`} className="h-28 xl:h-32 bg-[#1A1D27]/30 rounded-2xl border border-[#1E2230]/50" />;
          }
          ...
          return (
            <button
              ...
              className={clsx(
                'h-28 xl:h-32 rounded-2xl p-3 flex flex-col items-start justify-start relative transition-all border text-left overflow-hidden group',
                isSelected
